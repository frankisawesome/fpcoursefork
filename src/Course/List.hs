...
filter ::
  ...
  -> List a
  -> List a
filter condition list = case list of 
  Nil -> Nil
  a :. b ->  case (condition a) of
    True -> a :. filter condition b
    False -> filter condition b
...
flatMap ::
  ...
  -> List a
  -> List b
flatMap funclist list = case list of
  Nil -> Nil
  a :. b -> funclist a ++ flatMap funclist b
