...
lift4 ::
  ...
  -> f d
  -> f e
lift4 a b c d e = lift3 a b c d <*> e
...
(*>) ::
  ...
  -> f b
  -> f b
(*>) arg1 arg2 = lift2 (\_ b-> b) arg1 arg2
...
(<*) ::
  ...
  -> f a
  -> f b
(<*) arg1 arg2 = lift2 (\a _ -> a) arg1 arg2
...
sequence ::
  ...
  List (f a)
  -> f (List a)
sequence list = foldRight (lift2 (:.)) (pure Nil) list
